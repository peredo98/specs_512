Pod::Spec.new do |s|
  ...
  s.summary      = "CYBABO Auth APP SDK for iOS."
  s.description  = <<-DESC
Use CYBAVO Auth App SDK to easily develop app with authentication.
  ...
  s.platform     = :ios, "11.0"
  s.source       = { :git => "ssh://git@bitbucket.org/cybavo/auth-sdk_ios_release.git", :tag => "swift512_LIB_VERSION" }
  s.source_files  = "**/*.{h}"
  s.exclude_files = "Classes/Exclude"
  s.swift_version = '4.2.1'
  s.ios.vendored_frameworks = 'CYBAVOAuth.framework'
  s.resources = ['CYBAVAuth.framework/AuthSDK.plist']
